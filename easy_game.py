...
meteor_image = pygame.image.load("assets/Meteor1.png")

def generate_meteor(meteor_image):
    return {
        "mask":pygame.mask.from_surface(meteor_image),
        "x": random.choice(range(10,440,70)),
        "y": random.choice(range(-10,-500,-70))
    }
    ...
    while True:
        ...
        if len(meteors) == 0:
            ...
            for i in range(meteor_count):
                meteors.append(generate_meteor(meteor_image))
